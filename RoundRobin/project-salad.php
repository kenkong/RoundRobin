...
<br><br><br><br>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Salad Restaurant
                    <small>Food & Drink</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a>
                    </li>
                    <li class="active">Salad Restaurant</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <img class="img-responsive" src="salad2.jpg" alt="">
                        </div>
                        <div class="item">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    ...
                    <li>Business Folks</li>
                    <li>Venture Seekers</li>
                </ul>
            </div>
